...
function acceptEditInfo() {
    ...
    // bodyFormData.append('photos[]', img.files[0]);
    // bodyFormData.append('photomc[]', imgmc.files[0]);
...
let bandobosung = L.tileLayer('bandobosungvadieuchinh/{z}/{x}/{y}.png', options);
let bandophantich = L.tileLayer('bandophantich/{z}/{x}/{y}.png', options);
let bandotheoketqua = L.tileLayer('bandotheoketqua/{z}/{x}/{y}.png', options);
