...
/* harmony import */ var vue_template_compiler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-template-compiler */ "./node_modules/vue-template-compiler/browser.js");
/* harmony import */ var vue_template_compiler__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vue_template_compiler__WEBPACK_IMPORTED_MODULE_0__);

var map = L.map('map').setView([10.6079209, 105.1175397], 11);
var btnClose = document.getElementById('close-btn');
var panel = document.getElementById('panel');
var btnOpen = document.getElementById('show-btn');
var btnSubmit = document.getElementById('accept-new-info');
var titlePanel = document.getElementById('panel-title');
...
var geoserver = 'http://35.240.232.121:8080/geoserver/angiang/wms';
var urlImg = 'http://35.240.232.121/storage/uploadedimages/';
btnClose.addEventListener('click', closePanel.bind(undefined));
btnOpen.addEventListener('click', showPanel.bind(undefined)); // btnSubmit.addEventListener('click', acceptEditInfo.bind(this));
...
function getMarker() {
  var url = api + '/api/get-all-imgpoint';
  axios({
    method: 'get',
    url: url
  }).then(function (response) {
...
function clickMarker(feature, layer) {
  layer.on('click', function (e) {
    ...
    var photo = JSON.parse(feature.properties.Photos).img;
    var photomc = JSON.parse(feature.properties.Photos).imgmc;
    ...
    for (var _i = 0; _i < photomc.length; _i++) {
      createImgDiv(id, false, 'imgmc', photo[_i]);
    }
  });
}
...
var dangsau_2009_line = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var diemdosau_2019_point = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var diemdosau_2009_point = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var satlo_mohinhthuyluc_line = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var satlo_truottongthe_line = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var satloduongbo_gis_line = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var u_diem_mc_moi = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var u_anh = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var u_diem_sat_lo = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var u_doan_sat_lo = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var u_tram_do_thuy_van = L.tileLayer.wms(geoserver, {
  Format: 'image/png',
...
var bandobosung = L.tileLayer('/storage/bandobosungvadieuchinh/{z}/{x}/{y}.png', options);
var bandophantich = L.tileLayer('/storage/bandophantich/{z}/{x}/{y}.png', options);
var bandotheoketqua = L.tileLayer('/storage/bandotheoketqua/{z}/{x}/{y}.png', options); // marker.on('click', onMarkerClick);
...
L.control.locate().addTo(map); // add leaflet.pm controls with some options to the map
...
var searchControl = L.esri.Geocoding.geosearch().addTo(map); // create an empty layer group to store the results and add it to the map

var results = L.layerGroup().addTo(map); // listen for the results event and add every result to the map
...
map.on('pm:create', function (e) {
  ...
  var latlng = '';
  var url = api + 'api/get-matcat';
  var bodyFormData = new FormData();
  var coordinates = e.layer.getLatLngs();
...
module.exports = __webpack_require__(/*! E:\git-vlab\new-angiang\resources\js\map.js */"./resources/js/map.js");
