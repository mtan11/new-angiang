...
var panelUpdate = document.getElementById('panel-update');
...
var inputNameShow = document.getElementById('input-name-show');
var inputInfo = document.getElementById('input-info');
var inputInfoShow = document.getElementById('input-info-show');
var imgSlider = document.getElementById('img-slider');
var btnCloseUpdate = document.getElementById('close-update-btn');
...
function acceptEditInfo() {
  ...
  bodyFormData.set('xy', xy); // console.log(img.files.length);

  for (var i = 0; i < img.files.length; i++) {
    bodyFormData.append('photos[]', img.files[i]);
  }

  for (var _i = 0; _i < imgmc.files.length; _i++) {
    bodyFormData.append('photomc[]', imgmc.files[_i]);
  }
...
function clickMarker(feature, layer) {
  layer.on('click', function (e) {
    ...
    for (var _i2 = 0; _i2 < photomc.length; _i2++) {
      createImgDiv(id, false, 'imgmc', photo[_i2]);
    }
  });
}
...
function addMarker(e) {
  showPanel();
  showPanelUpdate();
  var newMarker = new L.marker(e.latlng).addTo(map); // console.log(e.latlng.lat);
...
var bandotheoketqua = L.tileLayer('/storage/bandotheoketqua/{z}/{x}/{y}.png', options);
...
/***/ 2:
/*!****************************************!*\
  !*** multi ./resources/js/map-edit.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\git-vlab\new-angiang\resources\js\map-edit.js */"./resources/js/map-edit.js");
